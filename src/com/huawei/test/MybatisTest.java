...
import com.huawei.model.Employeer;
...
public class MybatisTest
{
    ...
    public static void findEmployeerById(int id) {  
        ...
        try {  
            ...
            Employeer employeer = (Employeer) session.selectOne(  
                    "com.huawei.model.EmployeerMapper.findEmployeerByID", 1);  
            if (employeer == null)  
    ...
    public static void addEmployeer(Employeer employeer){  
        ...
        try {  
            session = sqlSessionFactory.openSession();  
             //返回值是记录条数    
            int resultCount = session.insert("com.huawei.model.EmployeerMapper.addEmployeer", employeer );    
    ...
    public static void deleteEmployeer(int id){  
        ...
        try {  
            session = sqlSessionFactory.openSession();  
             //返回值是记录条数    
             int resultCount=session.delete("com.huawei.model.EmployeerMapper.deleteEmployeer",id);   
    ...
    public static void updateEmployeer(Employeer employeer){  
        ...
        try {  
            session = sqlSessionFactory.openSession();   
            session.update("com.huawei.model.EmployeerMapper.updateEmployeer",employeer);      
            session.commit() ;            
        } finally {  
            session.close();  
        }  
...
//        deleteEmployeer(1);  
//        //更改  
        employeer2.setEmployeer_id(3);  
        employeer2.setEmployeer_age(21);  
        employeer2.setEmployeer_department("产品五部");  
